...
const oauthHostName = 'auth.'.concat(cognitoVars.DOMAIN_PREFIX, cognitoVars.DOMAIN); 
 
// The URI the auth server should redirect the browser to 
const redirectUri = 'https://private.'.concat(cognitoVars.DOMAIN_PREFIX, cognitoVars.DOMAIN, '/index.html'); 
 
// The URI of the login server 
const loginURI = 'https://'.concat(oauthHostName, 
    ...
    var tokenResponse = new Promise((resolve, reject) => { 
        ...
        return { 
            ...
            headers: { 
                ...
                'set-cookie': [{ 
                    value: 'AuthState=;Max-Age=0;Secure;HttpOnly;SameSite=Strict;Domain=private.'.concat(cognitoVars.DOMAIN_PREFIX, 
                                                                                                                                                                                             cognitoVars.DOMAIN) 
                },{ 
                    value: 'CodeVerifier=;Max-Age=0;Secure;HttpOnly;SameSite=Strict;Domain=private.'.concat(cognitoVars.DOMAIN_PREFIX, 
                                                                                                                                                                                                    cognitoVars.DOMAIN) 
                },{ 
                    value: 'AccessToken='.concat(body.access_token, 
                                                                             ';Max-Age=', 
                                                                             body.expires_in, 
                                                                             ';Secure;HttpOnly;SameSite=Strict;Domain=private.', 
                                                                             cognitoVars.DOMAIN_PREFIX, 
                                                                             cognitoVars.DOMAIN) 
                }] 
            } 
        }; 
...
const authenticate = async () => { 
    ...
    //const codeVerifier = crypto.createHash('sha256').update(stateBuffer).digest('base64'); 
        ...
        headers: { 
            ...
            'set-cookie': [{ 
                value: 'AuthState='.concat(stateVal, 
                                                                     ';Max-Age=3600;Secure;HttpOnly;SameSite=Strict;Domain=private.', 
                                                                     cognitoVars.DOMAIN_PREFIX, 
                                                                     cognitoVars.DOMAIN) 
            },{ 
